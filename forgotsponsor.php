...
<p></td>
	...
	<tr>
		<td style="background-image: url(images/index_21.jpg);" width="13">&nbsp;	  </td>
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			<p class="o" style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">
			Username or e-mail address:</p>
			<form action="forgotsponsor2.php" method="POST" class="o">
				<p style="margin-left: 5px; margin-right: 3px; margin-top: 0; margin-bottom: 0">
				<input name="T2" type="text" class="o" size="20">
				<input type="image" src="images/pressme.jpg"  name="B2" value="Submit"></p>
		  </form>
			<p style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">
			<span class="o">
			<img border="0" src="images/arr2.jpg" width="10" height="7" alt=""> 
			Your current password will be e-mailed to you.</span></p>
			<p style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">&nbsp;</p>
			<p style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">&nbsp;</p>
	  </td>
	</tr>
	<tr>
