...
<table id="table1" width="145" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			Frequently Asked Questions</font></span></p>
			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			<span class="o">
			<br>
			</span><?
			$number = 0;
...
$number = $number + 1;
echo "<p style=\"margin-left: 5px; margin-right: 5px; margin-bottom:0\"><span class=\"txtn\">$number. <a href=\"#$number\" style=\"text-decoration: none\"><font color=\"#D61217\">$row[question]</font></a> </span></p>";
}
mysql_free_result($result);
?>			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">&nbsp;
			
			</p>
			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">&nbsp;<span class="txtn"><font color="#D61217"><img border="0" src="images/help.jpg" width="36" height="36" style="vertical-align:middle;" alt=""> 
			Answers to 
			Frequently Asked Questions</font></span></p>
			<p>
<p style="margin-left: 5px; margin-right: 5px">
			...
			<?
$sqll = "SELECT question, answer FROM faq";
$resultl = mysql_query($sqll);

			$number = 0;
while ($raw = mysql_fetch_assoc($resultl)) {
$number = $number + 1;
echo "<br><br><span class=\"txtn\"><a name=\"$number\"></a>$number. $raw[question] </span><p style=\"margin-left: 5px; margin-right: 5px\"><span class=\"o\">$raw[answer]</span>";
}
