...
$country = $_POST[countryon];


                                                  $myemail = "admin@yoursite.com"; 
...
if ($myemail != "") 
mail($myemail, $subject, $message, sysmail());
...
<p>&nbsp;</p>
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			&nbsp;<p align="center" class="o">
			&nbsp;<p align="center" class="o">
			Thank you for contacting us. We will respond as soon as possible.<p align="center" class="o">
			<a href="index.php">Return to homepage</a><p align="center" class="o">
			<p align="center" class="o">
			<p align="center" class="o">
			<p align="center" class="o">
			<p align="center" class="o">
