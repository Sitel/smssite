...
<table id="table1" width="145" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			We collect all information that you voluntarily disclose in the 
			course of using our site. We use information that we obtain from 
			your current and past activities on the site, to resolve disputes, 
			troubleshoot problems and, if we deem necessary, to enforce our 
			Terms of Use.<br>
			<br>
			<b>Collecting e-mail addresses</b><br>
			Our use for your personal information may include things such as:<br>
			<br>
			1. Notifying you of important changes<br>
			2. Inform you when you may have received free credits if you have 
			taken part in our promotions. <br>
			<br>
			<b>Certain Exceptional Disclosures</b><br>
			...
			conduct or potential threats to the physical safety of any person. 
			Disclosure may be required by law or if we receive legal process.<br>
			<br>
			<b>Use of Cookies</b><br>
			Our site uses cookies to store the preferences of users.<br>
			<br>
			<b>Physical Security</b><br>
			...
			information that we have collected from you at our site.<br>
			<br>
