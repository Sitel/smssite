...
if (!$error)
{
mysql_query("UPDATE users SET sms = sms-1 WHERE username = '$username'");
...
<table id="table1" width="144" height="144" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>
			<p style="margin-left: 1px">
			<a href="<? echo $fff[0]; ?>" target="_blank" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Forums','','imagesforums2.jpg',1)"><img src="imagesforums.jpg" alt="Forums" name="Forums" width="144" height="18" border="0"></a></td>
	</tr>
	<tr>
		<td>
			<p style="margin-left: 1px">
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
		                    ...
		                    <span class="txtn">Let's send SMS messages!</span><p>&nbsp;
<?
if ($error) {
...
echo "			<p style=\"margin-left: 5px; margin-right: 5px\" align=\"center\" class=\"o\">&nbsp;			
			<a href=\"sendsms.php\">Go back</a></p>";
}
else
{
      echo "<br><br><p style=\"margin-left: 5px; margin-right: 5px; margin-bottom:0\" align=\"center\">			<span class=\"o\"><br>
			SMS was successfully sent</span></p><br><br><br><br>";
