...
<p>&nbsp;</p>
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			You are not logged in.<p align="center" class="o" style="margin-left: 5px; margin-right: 5px">
			<a href="index.php">Log in to your account here</a>.<p align="center" class="o" style="margin-left: 5px; margin-right: 5px">
			&nbsp;<p align="center" class="o" style="margin-left: 5px; margin-right: 5px">
			&nbsp;<p align="center" class="o" style="margin-left: 5px; margin-right: 5px">
			&nbsp;<p align="center" class="o" style="margin-left: 5px; margin-right: 5px">
			&nbsp;<p align="center" class="o" style="margin-left: 5px; margin-right: 5px">
