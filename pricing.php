...
?></td>
	...
	<tr>
		...
		<td colspan="2">
			<a href="support.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Support','','images/over_14.jpg',1)"><img src="images/index_16.jpg" name="Support" width="112" height="24" border="0" alt="Suport"></a></td>
	</tr>
	<tr>
		<td colspan="17">
...
<table id="table1" width="145" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		 </td>
		<td colspan="13">
			<img src="images/pricing.jpg" width="639" height="23" alt=""></td>
		<td>
...
echo "<p>$row[credits] SMS credits for $$row[price]</p>";
}
