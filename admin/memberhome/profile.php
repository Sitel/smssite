...
$check = mysql_query("SELECT name, firstname, active, sms , address, city, state, zip, country, home, email FROM users WHERE username = '$username'");
$row = mysql_fetch_row($check); 
...
<form method="POST" action="profile2.php" >
  <table width="100%"  border="0" cellpadding="5" cellspacing="1" class="box_inner" id="table2">
		    ...
		    <td >
			<input name="firstname" type="text" class="o"  value="<? echo $_SESSION['firstname']; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
		  <tr>
		    <td width="200" class="o">Last Name</td>
		    <td >
			<input name="name" type="text" class="o"  value="<? echo $_SESSION['name']; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
			<tr>
	...
	<p>
			...
			<form method="POST" action="password.php">
				<p class="o" style="margin-left: 5px; margin-right: 5px; margin-bottom: 0"> 
				Current password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
			    <input name="T1" type="password" class="o" size="20">
			    </p>
				<p class="o" style="margin-left: 5px; margin-right: 5px; margin-bottom: 0"> 
				New password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
			    <input name="T2" type="password" class="o" size="20">
			    </p>
				<p style="margin-left: 5px; margin-right: 5px; margin-bottom: 0"><span class="o"> 
				Repeat new password:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="o"> 				
			    <input name="T3" type="password" class="o" size="20">
                </span> </p>
				<p style="margin-left: 5px; margin-right: 5px; margin-bottom: 0">
				<input type="image" src="images/pressme.jpg"  name="B5" class="o" value="Submit"></p>
		  </form>
			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">&nbsp;			&nbsp;			</p>
			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			</form></p>
	  </td>
	</tr>
	<tr>
		<td colspan="17">
