...
<p>&nbsp;</p> 
		...
		<td colspan="13">
			<img src="images/historytop.jpg" alt="" width="639" height="23"></td>
		<td>
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			Message History</span></p>
			<form method="POST" action="csv.php">
				<p style="margin-left: 5px; margin-right: 5px; margin-bottom: 0">
				<input class="o" type="submit" value="Download CSV" name="B3"></p>
			</form>
			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			
			&nbsp;</p><? 
...
if (mysql_num_rows($result) == 0) {
   echo "		<p align=\"center\" class=\"o\" style=\"margin-right: 25px; margin-left:10px\">
			No messages found<br><p style=\"margin-left: 5px; margin-right: 5px\">
";
   $check = "ho";
}
if ($check != 'ho')
{
echo "      <table class=\"o\" cellspacing=1 cellpadding=2 border=0 width=100% style=\"border:1 #CCCCCC Solid\">
        <tr bgcolor=CCCCCC>
...
echo "        <tr height=20 bgcolor=#E5E5E5>
					   <td valign=top nowrap>$row[date]</td>
					   <td valign=top>$row[fromno]</td>
...
?>
<br><p style="margin-left: 5px; margin-right: 5px">
	  &nbsp;</td>
	</tr>
	<tr>
		<td colspan="17">
