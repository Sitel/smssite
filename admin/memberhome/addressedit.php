...
session_start(); 
$id = $_GET[user];
$cec = mysql_query("SELECT * FROM addressbook WHERE id = '$id'");
$randi = mysql_fetch_row($cec); 
...
<br><br><br><br>		</td>
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">		<form method="POST" action="addressedit2.php?user=<? echo $id; ?>" >
  				<p>&nbsp;</p>
  <table width="100%"  border="0" cellpadding="5" cellspacing="1" class="box_inner" id="table2">
          ...
          <tr>
		    ...
		    <td >
			<input name="nickname" type="text" class="o"  value="<? echo $randi[1]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
      ...
      <font color="#FF0000">*</font><span class="o"> </span></td>
            <td >
			<input name="mobile" type="text" class="o" id="email"  value="<? echo $randi[2]; ?>" size="30" maxlength="65" /></td>
          </tr>
          <tr>
		    <td width="172" class="o">Fax</td>
		    <td >
			<input name="fax" type="text" class="o"  value="<? echo $randi[13]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
			<tr>
		    <td width="172" class="o">Home Phone</td>
		    <td >
			<input name="home" type="text" class="o"  value="<? echo $randi[11]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
          <tr>
...
?>
          ...
          <tr>
            ...
            <td >
			<input name="first" class="o"  value="<? echo $randi[4]; ?>" maxlength="65" size="30" />            </td>
          </tr>
		  <tr>
            <td width="172" class="o">Last Name</td>
            <td >
			<input name="last" class="o"  value="<? echo $randi[5]; ?>" maxlength="65" size="30" />            </td>

          </tr>
			<tr>
		    <td width="172" class="o">E-mail</td>
		    <td >
			<input name="email" type="text" class="o"  value="<? echo $randi[6]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
		  <tr>
		    <td width="172" class="o">Address</td>
		    <td >
			<input name="address" type="text" class="o"  value="<? echo $randi[7]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
			<tr>
		    <td width="172" class="o">City</td>
		    <td >
			<input name="city" type="text" class="o"  value="<? echo $randi[8]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
			<tr>
		    <td width="172" class="o">State</td>
		    <td >
			<input name="state" type="text" class="o"  value="<? echo $randi[9]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
			<tr>
		    <td width="172" class="o">ZIP</td>
		    <td >
			<input name="zip" type="text" class="o"  value="<? echo $randi[10]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
			<tr>
		    <td width="172" class="o">Country</td>
		    <td >
			<input name="country" type="text" class="o"  value="<? echo $randi[12]; ?>" size="30" maxlength="65" />
 </td>
    		</tr>
		  <tr>
		    <td width="172" class="o">Details</td>
		    <td >
			<textarea rows="6" name="details" cols="42"><? echo $randi[14]; ?></textarea>
 </td>
    </tr>
