...
$t = array("addressbook", "affiliates", "approve", "approvelog", "configuration", "extranumbers", "faq", "favlsit", "groups", "news", "paypal", "sms", "sponsor", "superior", "users");
$exporter = new SQL_Export("localhost:3306", "db_user", "pass", "dbname", $t);
$sql = $exporter->export();
