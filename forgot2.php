...
$check = mysql_query("SELECT username, password FROM users WHERE email = '$cec'");
...
If you did not ask for a password change, or you received this e-mail by mistake, please contact us as soon as possible here: support@yoursite.com
...
$check = mysql_query("SELECT password, email FROM users WHERE username = '$cec'");
$row = mysql_fetch_row($check); 
...
<p></td>
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			<img border="0" src="images/lock.jpg" width="32" height="32" style="vertical-align:middle;" alt=""><span class="txtn"> 
			Password recovery form</span><p style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">&nbsp;</p>
			<p align="center" class="o" style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">
			<? if ($ver == 1) { echo "Password successfully sent to your e-mail address!"; } else { echo "The specified username/e-mail is not in our database"; } ?></p>
			<p align="center" class="o" style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">
			&nbsp;</p>
			<p align="center" class="o" style="margin-left: 5px; margin-right:3px; margin-top:0; margin-bottom:0">
