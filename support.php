...
?></td>
	...
	<tr>
		<td colspan="17">
			<img src="images/top8.jpg" alt="" width="790" height="151"></td>
	</tr>
	<tr>
		<td>
...
<table id="table1" width="145" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="142">
			...
			<u>Better Support</u></p>
			<p class="o" style="margin-left: 6px; margin-top:0; margin-bottom:5px">
			In order to get faster answers, please include in your question all 
			the possible details for your problem.</p>
			</td>
		<td style="background-image: url(images/tabel_03.jpg);" width="3" height="136">
		  </td>
	</tr>
...
<p>&nbsp;</p>
	...
	<tr>
		<td style="background-image: url(images/backft0.jpg);">&nbsp;	  </td>
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			<span class="txtn">
			<a href="forum" style="text-decoration: none" target="_blank">
			<font color="#D61217">
			<img border="0" src="images/users.jpg" width="36" height="36" style="vertical-align:middle;" alt=""> 
			User Forums</font></a></span><span class="o"><br>
			<br>
			<br>
			<br>
			...
			Frequently Asked Questions</font></a></span><span class="o"><br>
			<br>
			<br>
			</span><span class="txtn">
			<img border="0" src="images/mail.jpg" width="32" height="32" style="vertical-align:middle;" alt=""> 
			Contact us via e-mail</span></p>
			<form method="POST" action="send.php">
				<table border="0" cellpadding="2" cellspacing="2" width="51%" id="table6">
                
                <tr>
                  <td class="o" width="100">E-mail address:</td>
                  <td>
				<input name="email" type="text" class="o" size="20"></td>

                </tr>

                    </table>

				<table border="0" cellpadding="2" cellspacing="2" width="51%" id="table7">
                
                <tr>
                  <td class="o" width="100">Name:</td>
                  <td>
				<input name="name" type="text" class="o" size="20"></td>

                </tr>

                    </table>

						<table border="0" cellpadding="2" cellspacing="2" width="51%" id="table4">
                
                <tr>
                  <td class="o" width="100">Department:</td>
                  <td><select name="department" size="1" class="o">
					<option selected value="Support">Support</option>
					<option value="Site not working / bugs">Site not working / bugs
					</option>
					<option value="Advertising">Advertising</option>
					<option value="Billing and Sales">Billing & Sales</option>
					</select></td>
						...
						<table border="0" cellpadding="2" cellspacing="2" width="68%" id="table5">
                
                <tr>
                  <td class="o" width="90">Question:</td>
                  <td width="290">
					<textarea name="question" cols="48" rows="8" class="o"></textarea></td>
