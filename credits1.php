...
<p>&nbsp;</td>
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(images/index_22.jpg);">
			...
			Credit request form</span></p>
			<form method="POST" action="credits2.php">
				<table border="0" cellpadding="2" cellspacing="2" width="58%" id="table6">
                
                <tr>
                  <td class="o" width="220">Your E-mail address:</td>
                  <td>
				...
				<table border="0" cellpadding="2" cellspacing="2" width="58%" id="table7">
                
                <tr>
                  <td class="o" width="220">Name:</td>
                  <td>
				...
				<table border="0" cellpadding="2" cellspacing="2" width="58%" id="table9">
                
                <tr>
                  <td class="o" width="220">Username you registered on the 
					dating site:</td>
                  <td>
				<input name="usernameon" type="text" class="o" size="20"></td>

                </tr>

                    </table>

				<table border="0" cellpadding="2" cellspacing="2" width="58%" id="table10">
                
                <tr>
                  <td class="o" width="220">Country you registered on the dating 
					site:</td>
                  <td>
				<input name="countryon" type="text" class="o" size="20"></td>
