...
$check = mysql_query("SELECT email FROM newsletter WHERE email = '$em'");
if(mysql_num_rows($check) == 0)  {
mysql_query("INSERT INTO newsletter (email) VALUES('".$em."')") or die(mysql_error());
}
echo $sus;
?>
...
<table id="table1" width="145" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="13" style="background-image: url(../../images/index_22.jpg);">
			...
			<p style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			&nbsp;</p>
			<p align="center" class="o" style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			
			Thank you for signing up with our newsletter!<br>
&nbsp;</p>
			<p align="center" class="o" style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			
			&nbsp;</p>
			<p align="center" class="o" style="margin-left: 5px; margin-right: 5px; margin-bottom:0">			
